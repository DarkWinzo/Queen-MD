...
global.ownername = process.env.OWNER_NAME === undefined ? "SanDy" : process.env.OWNER_NAME
let fake = process.env.OWNER_NUMBER === undefined ? '3547868888' : process.env.OWNER_NUMBER
global.owner = [`${fake}`]
